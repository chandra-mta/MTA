...
#############################################################################################
#                                                                                           #
#       create_front_history_files.py: create combined front side ccds history files        #
#                                                                                           #
...
#--------------------------------------------------------------------------------------------
#-- create_front_history_files: create combined front side ccds history files             ---
#--------------------------------------------------------------------------------------------

def create_front_history_files():
    """
