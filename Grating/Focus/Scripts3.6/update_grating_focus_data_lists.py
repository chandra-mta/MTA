...
#
        ...
        for path in n_list:
            ...
            [inst, grating, tstart, alrf10, alrf50, slrf10, slrf50,\
                                      fwhm_a, fwhm_s, error_a, error_b] = out
            if inst == 'acis_s':
                if grating == 'LETG':
...
#
    ...
    if (grating == '') or (tstart == ''):
        ...
        return [inst, grating, tstart, alrf10, alrf50, slrf10,\
                slrf50, fwhm_a, fwhm_s, error_a, error_s]
