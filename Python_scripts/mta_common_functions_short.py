...
#############################################################################
#                                                                           #
#       mta_common_functions_short.py: colleciton of funtions used by mta   #
#                                                                           #
#           this is same except without setascds setting which interfere    #
#           some python scripts on cus                                      #
#                                                                           #
