...
#--- directories
#
grad_dir = '/data/mta/Script/MTA_limit_trends/Deposit/Grad_save/'
#
#---grad msids
#
...
g_msid_list =[gradablk, gradahet, gradaincyl, gradcap, gradfap, \
              gradfblk, gradhcone, gradhhflex, gradhpflex, gradhstrut,\
              gradocyl, gradpcolb, gradperi, gradsstrut, gradtfte]

catg_list  =['Gradablk', 'Gradahet', 'Gradaincyl', 'Gradcap', 'Gradfap', \
              'Gradfblk', 'Gradhcone', 'Gradhhflex', 'Gradhpflex', 'Gradhstrut',\
              'Gradocyl', 'Gradpcolb', 'Gradperi', 'Gradsstrut', 'Gradtfte']
